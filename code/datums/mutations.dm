...
/datum/mutation/human/hulk/say_mod(message)
	if(message)
		message = "[uppertext(replacetext510(message, ".", "!"))]!!"
	return message
...
/datum/mutation/human/smile/say_mod(message)
	if(message)
		...
		message = replacetext510(message," stupid "," smart ")
		message = replacetext510(message," retard "," genius ")
		message = replacetext510(message," unrobust "," robust ")
		message = replacetext510(message," dumb "," smart ")
		message = replacetext510(message," awful "," great ")
		message = replacetext510(message," gay ",pick(" nice "," ok "," alright "))
		message = replacetext510(message," horrible "," fun ")
		message = replacetext510(message," terrible "," terribly fun ")
		message = replacetext510(message," terrifying "," wonderful ")
		message = replacetext510(message," gross "," cool ")
		message = replacetext510(message," disgusting "," amazing ")
		message = replacetext510(message," loser "," winner ")
		message = replacetext510(message," useless "," useful ")
		message = replacetext510(message," oh god "," cheese and crackers ")
		message = replacetext510(message," jesus "," gee wiz ")
		message = replacetext510(message," weak "," strong ")
		message = replacetext510(message," kill "," hug ")
		message = replacetext510(message," murder "," tease ")
		message = replacetext510(message," ugly "," beautiful ")
		message = replacetext510(message," douchbag "," nice guy ")
		message = replacetext510(message," whore "," lady ")
		message = replacetext510(message," nerd "," smart guy ")
		message = replacetext510(message," moron "," fun person ")
		message = replacetext510(message," IT'S LOOSE "," EVERYTHING IS FINE ")
		message = replacetext510(message," sex "," hug fight ")
		message = replacetext510(message," idiot "," genius ")
		message = replacetext510(message," fat "," thin ")
		message = replacetext510(message," beer "," water with ice ")
		message = replacetext510(message," drink "," water ")
		message = replacetext510(message," feminist "," empowered woman ")
		message = replacetext510(message," i hate you "," you're mean ")
		message = replacetext510(message," nigger "," african american ")
		message = replacetext510(message," jew "," jewish ")
		message = replacetext510(message," shit "," shiz ")
		message = replacetext510(message," crap "," poo ")
		message = replacetext510(message," slut "," tease ")
		message = replacetext510(message," ass "," butt ")
		message = replacetext510(message," damn "," dang ")
		message = replacetext510(message," fuck ","  ")
		message = replacetext510(message," penis "," privates ")
		message = replacetext510(message," cunt "," privates ")
		message = replacetext510(message," dick "," jerk ")
		message = replacetext510(message," vagina "," privates ")
	return trim(message)
...
/datum/mutation/human/swedish/say_mod(message)
	if(message)
		message = replacetext510(message,"w","v")
		if(prob(30))
...
/datum/mutation/human/chav/say_mod(message)
	if(message)
		message = " [message] "
		message = replacetext510(message," looking at  ","  gawpin' at ")
		message = replacetext510(message," great "," bangin' ")
		message = replacetext510(message," man "," mate ")
		message = replacetext510(message," friend ",pick(" mate "," bruv "," bledrin "))
		message = replacetext510(message," what "," wot ")
		message = replacetext510(message," drink "," wet ")
		message = replacetext510(message," get "," giz ")
		message = replacetext510(message," what "," wot ")
		message = replacetext510(message," no thanks "," wuddent fukken do one ")
		message = replacetext510(message," i don't know "," wot mate ")
		message = replacetext510(message," no "," naw ")
		message = replacetext510(message," robust "," chin ")
		message = replacetext510(message,"  hi  "," how what how ")
		message = replacetext510(message," hello "," sup bruv ")
		message = replacetext510(message," kill "," bang ")
		message = replacetext510(message," murder "," bang ")
		message = replacetext510(message," windows "," windies ")
		message = replacetext510(message," window "," windy ")
		message = replacetext510(message," break "," do ")
		message = replacetext510(message," your "," yer ")
		message = replacetext510(message," security "," coppers ")
	return trim(message)
...
/datum/mutation/human/elvis/say_mod(message)
	if(message)
		message = " [message] "
		message = replacetext510(message," i'm not "," I aint ")
		message = replacetext510(message," girl ",pick(" honey "," baby "," baby doll "))
		message = replacetext510(message," man ",pick(" son "," buddy "," brother"," pal "," friendo "))
		message = replacetext510(message," out of "," outta ")
		message = replacetext510(message," thank you "," thank you, thank you very much ")
		message = replacetext510(message," what are you "," whatcha ")
		message = replacetext510(message," yes ",pick(" sure", "yea "))
		message = replacetext510(message," faggot "," square ")
		message = replacetext510(message," muh valids "," getting my kicks ")
	return trim(message)
