...
//#define SLOT_BACK2		2048
#define SLOT_POCKET		2048//4096		//this is to allow items with a w_class of 3 or 4 to fit in pockets.
#define SLOT_DENYPOCKET	4096//8192	//this is to deny items with a w_class of 2 or 1 to fit in pockets.
