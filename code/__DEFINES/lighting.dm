...
#define LIGHT_COLOR_GLARE      "#77FF77" //Bright, non-saturated green. rgb(119, 255, 119)
#define LIGHT_COLOR_SLIME_LAMP "#AFC84B" //Weird color, between yellow and green, very slimy. rgb(175, 200, 75)
#define LIGHT_COLOR_TUNGSTEN   "#FAE1AF" //Extremely diluted yellow, close to skin color (for some reason). rgb(250, 225, 175)
#define LIGHT_COLOR_GAYBAR     "#FF66F1" //You're a superstar, at the gay bar. rgb(255, 102, 241)
#define LIGHT_COLOR_VANHELSING "#55BFFF" //Visible cyan-blue, that would be something to stop vampires or night-time zombies from coming over. rgb(85, 191, 255)
#define LIGHT_COLOR_LED        "#BFFFFF" //Rather visible soft cyan-ish hue. rgb(191, 255, 255)
