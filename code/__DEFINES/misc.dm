...
#define BODY_LAYER				24//25		//underwear, undershirts, socks, eyes, lips(makeup)
#define BODY_ADJ_LAYER			23//24
#define AUGMENTS_LAYER			22//23
#define FRONT_MUTATIONS_LAYER	21//22		//mutations that should appear above body and augments layer (e.g. laser eyes)
#define DAMAGE_LAYER			20//21		//damage indicators (cuts and burns)
#define UNIFORM_LAYER			19//20
#define ID_LAYER				18//19
#define SHOES_LAYER				17//18
#define GLOVES_LAYER			16//17
#define EARS_LAYER				15//16
#define SUIT_LAYER				14//15
#define GLASSES_LAYER			13//14
#define BELT_LAYER				12//13		//Possible make this an overlay of somethign required to wear a belt?
#define SUIT_STORE_LAYER		11//12
