...
var/global/list/global_weapon_list = list(
	///////////////////////////////  Оружие  /////////////////////////////////////////
...
var/global/list/global_med_list = list(
	///////////////////////////////	Медикаменты	/////////////////////////////////////////
...
var/global/list/global_food_list = list(
	/////////////////////////////////	Еда	///////////////////////////////////////////
...
var/global/list/global_unused_food_list = list(
...
var/global/list/global_misc_list = list(
	/////////////////////////////////	Другое	/////////////////////////////////////////////
...
var/global/list/global_detector_list = list(
	/////////////////////////////////	Детекторы	///////////////////////////////////////////
...
var/global/list/global_loot_list = list(
/////////////////////////////////	Лут с мутантов	///////////////////////////////////////////
...
var/global/list/global_artifact_list = list(
	/////////////////////////////////	Артефакты	///////////////////////////////////////////
...
var/global/list/global_attachment_list = list(
	/////////////////////////////////	Аттачменты	///////////////////////////////////////////
...
var/global/list/global_trash_list = list(
	/////////////////////////////////	Мусор	//////////////////////////////////////////////
...
/obj/machinery/stalker/sidormat/interact(mob/living/carbon/human/H)
	...
	///////////////////////////////////////////////////////////АНГЛИЙСКИЙ СИДОРОМАТ///////////////////////////////////////////////////////////////////////
		...
		for(var/datum/data/stalker_equipment/prize in global_weapon_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
		...
		for(var/datum/data/stalker_equipment/prize in global_ammo_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
		...
		for(var/datum/data/stalker_equipment/prize in global_armor_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
		...
		for(var/datum/data/stalker_equipment/prize in global_helmet_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
		...
		for(var/datum/data/stalker_equipment/prize in global_med_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
		...
		for(var/datum/data/stalker_equipment/prize in global_food_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
		...
		for(var/datum/data/stalker_equipment/prize in global_detector_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
		...
		for(var/datum/data/stalker_equipment/prize in global_misc_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
		...
		for(var/datum/data/stalker_equipment/prize in global_attachment_list)
			if((KPK.eng_faction_s == prize.faction && (KPK.eng_faction_s == "Loners" || (switches & SHOW_FACTION_EQUIPMENT))) || prize.faction == "Everyone")
				//if(rating >= prize.rating)
				if(get_assortment_level(H) >= prize.assortment_level)
					dat += "<tr><td>[prize.name]</td><td>[prize.cost]</td><td><A href='?src=\ref[src];purchase=\ref[prize]'>Buy</A></td></tr>"
