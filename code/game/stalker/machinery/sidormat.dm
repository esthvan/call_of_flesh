...
/obj/machinery/stalker/sidormat
	...
	var/list/weapon_list = list(
		...
		new /datum/data/stalker_equipment("АК 74/2 У (Зеленый)",	/obj/item/weapon/gun/projectile/automatic/aksu74/green,		20000, 1000),
		new /datum/data/stalker_equipment("АК 74/2",				/obj/item/weapon/gun/projectile/automatic/ak74,				25000, 1000),
		new /datum/data/stalker_equipment("АК 74/2 (Зеленый)",		/obj/item/weapon/gun/projectile/automatic/ak74/green,		25000, 1000),
	...
	var/list/ammo_list = list(
		...
		new /datum/data/stalker_equipment("Магазин к коре-919 и сип-т",/obj/item/ammo_box/magazine/stalker/sc45,				1400, 1000),
	...
	var/list/armor_list = list(
		...
		new	/datum/data/stalker_equipment("Бандитска#x44F; кожанка",/obj/item/clothing/suit/hooded/kozhanka/banditka,			5000, 0),
