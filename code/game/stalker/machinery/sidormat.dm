...
/obj/machinery/stalker/sidormat
	...
	var/list/weapon_list = list(
		...
		new /datum/data/stalker_equipment("SIG-Sauer P220",	"Ï-220",			/obj/item/weapon/gun/projectile/automatic/pistol/sip,				7500, EXPERT),
		new /datum/data/stalker_equipment("Colt M1911",		"Êîëüò",			/obj/item/weapon/gun/projectile/automatic/pistol/cora,				8000, EXPERT),
		new /datum/data/stalker_equipment("Beretta 92FS",	"Áåðåòòà",			/obj/item/weapon/gun/projectile/automatic/pistol/marta,				10000, EXPERT),
		new /datum/data/stalker_equipment("USP-match",		"ÞÑÏ-ìàò÷",			/obj/item/weapon/gun/projectile/automatic/pistol/usp_match, 		9000, EXPERT),

		///////////////////////////// **Àâòîìàòû, ÏÏ** /////////////////////////////////////
		new /datum/data/stalker_equipment("MP-5", 			"ÌÏ-5",				/obj/item/weapon/gun/projectile/automatic/mp5,						18000, NEWBIE),
		new /datum/data/stalker_equipment("AK 74/2 Ó", 		"ÀÊ 74/2 Ó",		/obj/item/weapon/gun/projectile/automatic/aksu74 ,					20000, NEWBIE),
		new /datum/data/stalker_equipment("AK 74/2", 		"ÀÊ 74/2",			/obj/item/weapon/gun/projectile/automatic/ak74,						25000, NEWBIE),
		new /datum/data/stalker_equipment("AC 96/2", 		"ÀÑ 96/2",			/obj/item/weapon/gun/projectile/automatic/abakan,					35000, EXPERT),
		...
		new /datum/data/stalker_equipment("Tunder OTs-14", 	"ÎÖ-14 Ãðîçà",		/obj/item/weapon/gun/projectile/automatic/groza,					40000, VETERAN),
		new /datum/data/stalker_equipment("Vintorez", 		"Âèíòîðåç",			/obj/item/weapon/gun/projectile/automatic/vintorez,					65000, MASTER),
		new /datum/data/stalker_equipment("L85", 			"Ë85",				/obj/item/weapon/gun/projectile/automatic/fnf2000,					70000, MASTER),
	...
	var/list/ammo_list = list(
		////////////////////////////////  Ïàòðîíû  /////////////////////////////////////////
		new /datum/data/stalker_equipment("9x18 Box", 				"Êîðîáêà 9õ18",								/obj/item/ammo_box/stalker/b9x18,						3750, NEWBIE),
		new /datum/data/stalker_equipment("9x18 AP Box", 			"Êîðîáêà 9x18 Áðîíåáîéíûå",					/obj/item/ammo_box/stalker/b9x18P,						7500, EXPERT),
		new /datum/data/stalker_equipment("9x19 Box", 				"Êîðîáêà 9x19",								/obj/item/ammo_box/stalker/b9x19,						4000, NEWBIE),
		new /datum/data/stalker_equipment("9x19 AP Box", 			"Êîðîáêà 9x19 Áðîíåáîéíûå",					/obj/item/ammo_box/stalker/b9x19P,						4000, EXPERT),
		new /datum/data/stalker_equipment(".45 ACP Box", 			"Êîðîáêà .45 ACP",							/obj/item/ammo_box/stalker/bacp45,						4000, NEWBIE),
		new /datum/data/stalker_equipment(".45 ACP Hydroshock Box", "Êîðîáêà .45 ACP Hydroshock",				/obj/item/ammo_box/stalker/bacp45ap,					5000, EXPERT),
		...
		new /datum/data/stalker_equipment("5.45x39 Box", 			"Êîðîáêà 5.45õ39",							/obj/item/ammo_box/stalker/b545,						5750, NEWBIE),
		new /datum/data/stalker_equipment("5.45x39 AP Box",			"Êîðîáêà 5.45õ39 Áðîíåáîéíûå",				/obj/item/ammo_box/stalker/b545ap,						7500, VETERAN),
		new /datum/data/stalker_equipment("5.56x45 Box",			"Êîðîáêà 5.56x45",							/obj/item/ammo_box/stalker/b55645,						6000, NEWBIE),
		new /datum/data/stalker_equipment("5.56x45 AP Box", 		"Êîðîáêà 5.56x45 Áðîíåáîéíûå",				/obj/item/ammo_box/stalker/b55645ap,					8000, VETERAN),
		new /datum/data/stalker_equipment("9x39 PAB-9 Box",			"Êîðîáêà 9x39 ÏÀÁ-9",						/obj/item/ammo_box/stalker/b939,						9000, EXPERT),
		new /datum/data/stalker_equipment("PMm; PB1s Magazine",		"Ìàãàçèí ê ÏÌì; ÏÁ1ñ",						/obj/item/ammo_box/magazine/stalker/m9x18pm,			750, NEWBIE),
		...
		new /datum/data/stalker_equipment("L85; LR-300 Magazine", 	"Ìàãàçèí ê Ë85; ËÐ-300",					/obj/item/ammo_box/magazine/stalker/m556x45,			2500, NEWBIE),
		new /datum/data/stalker_equipment("AS \"Val\" Magazine", 	"Ìàãàçèí ê ÀÑ \"Âàë\"",						/obj/item/ammo_box/magazine/stalker/sp9x39val,			3500, VETERAN),
		...
		new /datum/data/stalker_equipment("USP-match Magazine", 	"Ìàãàçèí ê ÞÑÏ-Ìàò÷",						/obj/item/ammo_box/magazine/stalker/usp45,				1500, NEWBIE),
		)
	...
	var/list/armor_list = list(
		...
		new	/datum/data/stalker_equipment("Bandit jacket",			"Áàíäèòñêà&#x44F; êîæàíêà",		/obj/item/clothing/suit/hooded/kozhanka/banditka,			5000, NEWBIE),
		...
		new /datum/data/stalker_equipment("Guardian of Freedom",	"Ñòðàæ Ñâîáîäû",				/obj/item/clothing/suit/hooded/kombez/strazh,				25000, EXPERT),//, "Ñâîáîäà"),
