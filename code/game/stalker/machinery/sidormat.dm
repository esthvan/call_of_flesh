...
/obj/machinery/stalker/sidormat
	...
	var/list/ammo_list = list(
		...
		new /datum/data/stalker_equipment("L85; LR-300 Magazine", 	"Магазин к Л85; ЛР-300",					/obj/item/ammo_box/magazine/stalker/m556x45,			3500, NEWBIE),
		...
		new /datum/data/stalker_equipment("PKM ammo belt box", 	    "Коробка патрон к ПКМ",					 	/obj/item/ammo_box/magazine/stalker/pkm,				15000, EXPERT),
		)
	...
	var/list/armor_list = list(
		...
		new /datum/data/stalker_equipment("Wind of Freedom",	    "Ветер Свободы",				/obj/item/clothing/suit/hooded/kombez/veter,				25000, NEWBIE, "Свобода"),
		...
		new /datum/data/stalker_equipment("Heavy merc armor",		"Тяжелая броня наёмников",		/obj/item/clothing/suit/assaultmerc,						50000, VETERAN, "Наёмники"),
