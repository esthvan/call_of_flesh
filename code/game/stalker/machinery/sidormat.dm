...
/obj/machinery/stalker/sidormat
	...
	var/list/ammo_list = list(
		...
		new /datum/data/stalker_equipment("Коробка 9x39 ПАБ-9",			/obj/item/ammo_box/stalker/b939,						9000, EXPERT),
		...
		new /datum/data/stalker_equipment("Магазин к АК 74/2;AK 74/2У;АС 96/2",/obj/item/ammo_box/magazine/stalker/m545,		2250, NEWBIE),
		new /datum/data/stalker_equipment("Магазин к ИЛ-86 и ТПС-301",/obj/item/ammo_box/magazine/stalker/m556x45,				2500, NEWBIE),
	...
	var/list/armor_list = list(
		...
		new	/datum/data/stalker_equipment("Экзоскелет",				/obj/item/clothing/suit/hooded/kombez/exoskelet,			150000, MASTER),
		)
