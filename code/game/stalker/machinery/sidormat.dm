...
/obj/machinery/stalker/sidormat
	...
	var/list/weapon_list = list(
		...
		new /datum/data/stalker_equipment("PPSh",			"ППШ",				/obj/item/weapon/gun/projectile/automatic/ppsh,						14000, ROOKIE),
	...
	var/list/misc_list = list(
		...
		new /datum/data/stalker_equipment("Matches",							"Спички",											/obj/item/weapon/storage/box/matches,										750, ROOKIE),
