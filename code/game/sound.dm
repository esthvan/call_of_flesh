...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("bushsound") soundin = pick('sound/effects/footsteps/bush/bushes1.ogg', 'sound/effects/footsteps/bush/bushes2.ogg')
			if ("metalfootsteps") soundin = pick('sound/effects/footsteps/metal/metal1.ogg', 'sound/effects/footsteps/metal/metal1.ogg')
	return soundin
