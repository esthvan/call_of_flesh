...
/obj/item/clothing/suit/armor/plate/crusader
	...
	armor = list(melee = 50, bullet = 50, laser = 50, burn = 40, bomb = 60, bio = 0, rad = 0)
...
/obj/item/clothing/head/helmet/plate/crusader/prophet
	...
	flags = 0
	armor = list(melee = 60, bullet = 60, laser = 60, burn = 50, bomb = 70, bio = 50, rad = 50) //religion protects you from disease and radiation, honk.
	worn_x_dimension = 64
	worn_y_dimension = 64
...
/obj/item/clothing/shoes/plate
	...
	icon_state = "crusader"
	w_class = 3 //normal
	armor = list(melee = 50, bullet = 50, laser = 50, burn = 40, bomb = 60, bio = 0, rad = 0) //does this even do anything on boots?
	flags = NOSLIP
