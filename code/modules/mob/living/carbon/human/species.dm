...
/datum/species/proc/handle_hud_icons(mob/living/carbon/human/H)
	...
	if(H.staminas)
		if(H.stat == DEAD)
			...
			switch(H.hal_screwyhud)
				if(1)	H.staminas.icon_state = "stamina0"
				if(2)	H.staminas.icon_state = "stamina0"
				if(5)	H.staminas.icon_state = "stamina11"
				else
					switch(H.staminaloss)
						if(100 to INFINITY)		H.staminas.icon_state = "stamina0"
						if(90 to 100)			H.staminas.icon_state = "stamina1"
						if(80 to 90)			H.staminas.icon_state = "stamina2"
						if(70 to 80)			H.staminas.icon_state = "stamina3"
						if(60 to 70)			H.staminas.icon_state = "stamina4"
						if(50 to 60)			H.staminas.icon_state = "stamina5"
						if(40 to 50)			H.staminas.icon_state = "stamina6"
						if(30 to 40)			H.staminas.icon_state = "stamina7"
						if(20 to 30)			H.staminas.icon_state = "stamina8"
