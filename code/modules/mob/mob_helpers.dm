...
/proc/derpspeech(message, stuttering)
	message = replacetext510(message, " am ", " ")
	message = replacetext510(message, " is ", " ")
	message = replacetext510(message, " are ", " ")
	message = replacetext510(message, "you", "u")
	message = replacetext510(message, "help", "halp")
	message = replacetext510(message, "grief", "grife")
	message = replacetext510(message, "space", "spess")
	message = replacetext510(message, "carp", "crap")
	message = replacetext510(message, "reason", "raisin")
	if(prob(50))
