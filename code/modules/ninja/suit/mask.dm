...
/obj/item/clothing/mask/gas/voice/space_ninja/speechModification(message)
	if(voice == "Unknown")
		if(copytext(message, 1, 2) != "*")
			...
			message = replacetext510(message, "l", "r")
			message = replacetext510(message, "rr", "ru")
			message = replacetext510(message, "v", "b")
			message = replacetext510(message, "f", "hu")
			message = replacetext510(message, "'t", "")
			message = replacetext510(message, "t ", "to ")
			message = replacetext510(message, " I ", " ai ")
			message = replacetext510(message, "th", "z")
			message = replacetext510(message, "is", "izu")
			message = replacetext510(message, "ziz", "zis")
			message = replacetext510(message, "se", "su")
			message = replacetext510(message, "br", "bur")
			message = replacetext510(message, "ry", "ri")
			message = replacetext510(message, "you", "yuu")
			message = replacetext510(message, "ck", "cku")
			message = replacetext510(message, "eu", "uu")
			message = replacetext510(message, "ow", "au")
			message = replacetext510(message, "are", "aa")
			message = replacetext510(message, "ay", "ayu")
			message = replacetext510(message, "ea", "ii")
			message = replacetext510(message, "ch", "chi")
			message = replacetext510(message, "than", "sen")
			message = replacetext510(message, ".", "")
