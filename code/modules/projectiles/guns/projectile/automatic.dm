	...
	if(istype(A, /obj/item/ammo_box/magazine))
		...
		if(istype(AM, mag_type))
			if(magazine)
				...
				user.say(pick("œ≈–≈«¿–ﬂ∆¿ﬁ—‹!!!", "ﬂ œ”—“, Ã≈Õﬂﬁ Ã¿√¿«»Õ!!!", "Ã≈Õﬂﬁ Ã¿√¿«»Õ!!!", "œ–» –Œ…! œ≈–≈«¿–ﬂ∆¿ﬁ—‹!!!", "ÕŒ¬€… Ã¿√¿«»Õ!!!"))
				magazine.loc = get_turf(src.loc)
				magazine.update_icon()
				magazine = null
				if(prob(5) && !jam)
					jam = 1
					user << "<span class='warning'>ŒÛÊËÂ Á‡ÍÎËÌËÎÓ. ≈„Ó ÌÂÓ·ıÓ‰ËÏÓ ÔÂÂÁ‡&#255;‰ËÚ¸. ÕÓÏ‡Î¸ÌÓ ÔÂÂÁ‡&#255;‰ËÚ¸.</span>"
			else
