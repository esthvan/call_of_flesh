...
//					'sound/stalker/ambience/rnd_outdoor/rnd_crow_11.ogg','sound/stalker/ambience/rnd_outdoor/rnd_crow_12.ogg') //Õ‡‰Ó Â˘Â ‰Ó·‡‚ËÚ¸

/area/stalker/sidor
	name = "Sidorovich Basement"
	icon_state = "sidor"
	requires_power = 1
	ambientsounds = list('sound/stalker/ambience/sidor_music.ogg','sound/stalker/ambience/sidor_music2.ogg')
