...
var/list/banditlatejoin = list()
var/list/armylatejoin = list()
var/list/sidorlatejoin = list()
var/list/jobnamelatejoin = list()
var/list/jobnamelatejoincount = list()
